...
test-unit:
    ...
    if command -v cargo-nextest &>/dev/null; then
        ...
        # covers the crates upstream enumerates individually (voice, db,
        # conformance, push-gateway, kubernetes backend) and picks up new
        # workspace members without an edit here.
