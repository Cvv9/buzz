                    ...
                    match buzz_event {
                        Some(buzz_event) => {
                            ...
                            // it never revokes same-owner team bots.
                            {
                                ...
                                // Accept the upstream relay's legacy kind:9
                                // workflow envelope too. VarVik's own relay
                                // uses the stricter kind:46008 task above.
                                let author = workflow_attributed_author(
                                    &buzz_event.event,
                                    relay_self.as_deref(),
                                )
                                .unwrap_or(author);
