...
const overrides = new Map([
  ...
  // +11 (1085 -> 1096): merge with fork main — close-to-tray keeps two atomic
  // lifecycle flags in the shared Tauri state and initializes them fail-closed
  // before frontend settings load.
  ["src-tauri/src/app_state.rs", 1096],
  ...
  // or ratchet down once upstream resolves it.
