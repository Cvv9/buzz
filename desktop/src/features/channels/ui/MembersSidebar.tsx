...
export function MembersSidebar({
  ...
  // Distinguish "you can't add here" from "nothing to add" so a plain member
  // of a private channel gets the reason instead of a silently missing affordance.
  ...
  const addSearchResults = React.useMemo(() => {
    ...
    const addCandidate = (candidate: AddMemberSearchCandidate) => {
      ...
      if (
        ...
        !isAgentIdentityInKnownDirectories(candidate, allowedAgentPubkeys)
      ) {
        return;
      }
